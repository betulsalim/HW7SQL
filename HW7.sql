...
--film sayısı 50 den fazla olan replacement_cost değerini ve karşılık gelen 
...
--sonra en fazla şehir sayısı barındıran country_id bilgisini ve şehir sayısını 
--paylaşınız.
